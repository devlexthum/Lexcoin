...
import (
   ...
   "github.com/devlexthum/Lexcoin/lotus/chain/types/ethtypes"
...
type FullNode interface {
    ...
    // EthAddressToLexcoinAddress converts an EthAddress into an f410 Lexcoin Address
    EthAddressToLexcoinAddress(ctx context.Context, ethAddress ethtypes.EthAddress) (address.Address, error) //perm:read
    // LexcoinAddressToEthAddress converts an f410 or f0 Lexcoin Address to an EthAddress
    LexcoinAddressToEthAddress(ctx context.Context, lexcoinAddress address.Address) (ethtypes.EthAddress, error) //perm:read
