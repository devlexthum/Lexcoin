#!/usr/lex/env python3
# Copyright (c) 2018-2022 Lexcoin Core developers
"""Test block processing.

This reimplements tests from the Lexcoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure Lexcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure Lexcoind isn't accepting b28
        ...
        #
        # b40 creates 3333 tx's spending the 6-sigop P2SH outputs from b39 for a total of 40171 sigops.
        ...
        #    Low-S and High-S values (whereas the Lexcoin code has custom code which does so);
